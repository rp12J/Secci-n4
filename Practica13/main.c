...
y las tres siguientes posiciones es el precia de la habitación en temporada baja, media y alta.

Ejemplo: [[1,120,150,220], [2,130,160,230], [3,100,120,200]]

Escribe un programa en el que se defina una matriz «omo la anterior y muestre el promedio de cada una de las temporadas. */
